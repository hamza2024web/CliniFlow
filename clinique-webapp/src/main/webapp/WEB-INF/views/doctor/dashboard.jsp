    ...
    <main class="main-content">
        <div class="top-bar">
            <div class="welcome-section">
                <h1>Bienvenue, Dr. ${sessionScope.user.nom}</h1>
                <p>${sessionScope.user.email}</p>
            </div>
            <div class="user-info">
                <div class="user-avatar">${sessionScope.user.nom.substring(0,1)}</div>
                <div class="user-details">
                    <h3>Dr. ${sessionScope.user.nom}</h3>
        ...
        <div class="actions-section">
            ...
            <div class="action-list">
                <div class="action-item">
                    <span class="action-text">Consulter mon agenda</span>
                    <span class="action-arrow">→</span>
                </div>
                <div class="action-item">
                    <span class="action-text">Gérer mes disponibilités</span>
                    <span class="action-arrow">→</span>
                </div>
                <div class="action-item">
                ...
                <div class="action-item">
                    <span class="action-text">Rédiger des notes médicales</span>
                    <span class="action-arrow">→</span>
                </div>
            </div>
        </div>
