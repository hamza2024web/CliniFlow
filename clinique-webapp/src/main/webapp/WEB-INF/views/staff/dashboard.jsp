...
<div class="dashboard-container">
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            ...
            <span class="role-badge">PERSONNEL</span>
        </div>
    ...
    <main class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card purple">
                ...
                <h3>Plannings gérés</h3>
                <div class="stat-value">45</div>
            </div>
            <div class="stat-card orange">
                <div class="stat-icon">📋</div>
                <h3>RDV créés ce mois</h3>
        ...
        <div class="actions-section">
            ...
            <div class="action-list">
                <div class="action-item">
                    <span class="action-text">Gérer les plannings</span>
                    <span class="action-arrow">→</span>
                </div>
                <div class="action-item">
                    <span class="action-text">Créer des rendez-vous pour les patients</span>
                    <span class="action-arrow">→</span>
                </div>
                <div class="action-item">
                    <span class="action-text">Gérer les listes d'attente</span>
                    <span class="action-arrow">→</span>
                </div>
                <div class="action-item">
                    <span class="action-text">Consulter les disponibilités des docteurs</span>
                    <span class="action-arrow">→</span>
                </div>
            </div>
        </div>
